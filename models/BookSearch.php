...
class BookSearch extends Books
{
    ...
    public function search($params)
    {
        ...
        if (!empty($this->date_start) && empty($this->date_end)) {
            $query->andFilterWhere(['>=', 'date', strtotime($this->date_start)]);
        } elseif (empty($this->date_start) &&  !empty($this->date_end)) {
            $query->andFilterWhere(['<=', 'date', strtotime($this->date_end)]);
        } elseif (!empty($this->date_start) &&  !empty($this->date_end)) {
            $query->andFilterWhere(['between', 'date', strtotime($this->date_start), strtotime($this->date_end)]);
        }
